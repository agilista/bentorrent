...
import uk.co.itstherules.external.ApacheAutoCloseInputStream;
...
public class BDecoder {
    ...
    private static final char NUMBER_INDICATOR = 'i';
    private static final char LIST_INDICATOR = 'l';
    private static final char BYTE_INDICATOR = 'd';
    private static final char ZERO_INDICATOR = '0';
    private static final char NINE_INDICATOR = '9';
	...
	public static BEValue bdecode(ByteBuffer data) throws IOException {
		return BDecoder.bdecode(new ApacheAutoCloseInputStream(
	...
	public BEValue bdecode() throws IOException	{
		...
		if (this.indicator >= ZERO_INDICATOR && this.indicator <= NINE_INDICATOR)
			return this.bdecodeBytes();
		else if (this.indicator == NUMBER_INDICATOR)
			return this.bdecodeNumber();
		else if (this.indicator == LIST_INDICATOR)
			return this.bdecodeList();
		else if (this.indicator == BYTE_INDICATOR)
