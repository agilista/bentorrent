...
public class Piece implements Comparable<Piece> {
    ...
    private static final SlfLogger logger =
            SlfLoggerFactory.getLogger(Piece.class);
    ...
    public synchronized boolean validate() throws IOException {
        if (this.seeder) {
            logger.trace("Skipping validation of {0} (seeder mode).", this);
            this.valid = true;
            return true;
        }

        logger.trace("Validating {0}...", this);
        this.valid = false;
