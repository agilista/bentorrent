 ...
 *
 * @version $Id: ApacheAutoCloseInputStream.java 1304052 2012-03-22 20:55:29Z ggregory $
 * @since 1.4
 */
public class ApacheAutoCloseInputStream extends ApacheProxyInputStream {
     ...
     */
    public ApacheAutoCloseInputStream(InputStream in) {
        super(in);
    }

    /**
     * Closes the underlying input stream and replaces the reference to it
     * with a {@link ApacheClosedInputStream} instance.
     * <p/>
    ...
    public void close() throws IOException {
        in.close();
        in = new ApacheClosedInputStream();
    }
