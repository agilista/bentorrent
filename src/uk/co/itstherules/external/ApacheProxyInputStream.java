 ...
 *
 * @version $Id: ApacheProxyInputStream.java 1304052 2012-03-22 20:55:29Z ggregory $
 */
public abstract class ApacheProxyInputStream extends FilterInputStream {

    /**
     * Constructs a new ApacheProxyInputStream.
     *
     * @param proxy the InputStream to delegate to
     */
    public ApacheProxyInputStream(InputStream proxy) {
        super(proxy);
